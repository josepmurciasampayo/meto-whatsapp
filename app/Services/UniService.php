...
class UniService
{
   ...
   {
       if ($statuses) {
            return UniService::getStudentTableData($uni_id);
       } else {
            return UniService::getStudentTableData($uni_id, $statuses);
       }
   }

   public static function studentTableQuery(int $uni_id, array $statuses): Builder
   {
        $query = '
        select
