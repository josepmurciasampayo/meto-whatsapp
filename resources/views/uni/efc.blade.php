<x-app-layout>
    <div class="min-h-screen items-center">
        ...
        <x-input-text name="efc"  help="example: The cost of attendance (tuition + rooming + food + health insurance + books + misc
        ...
        please input 10,000 for your answer."></x-input-text>
        <x-button-navigation/>
    </form>
</x-app-layout>
