<x-app-layout>
    ...
    <div class="p-6">
        ...
        <ul>
            <li><a href="{{ route('counselor-students', ['highschool_id' => $school->id] ) }}">My students</a></li>
            <li><a href="{{ route('counselor-matches', ['highschool_id' => $school->id] ) }}">Review matches</a></li>
            <?php if (Auth()->user()->isSchoolAdmin()) { ?>
                <br/>
                <li><a href="{{ route('highschool', ['highschool_id' => $school->id]) }}">Institution profile</a></li>
