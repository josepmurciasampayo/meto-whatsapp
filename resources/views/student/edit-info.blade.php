...
<x-status-icon href="/student-profile" icon="fa fa-user" text="My Profile" progress="{{ rand(1, 100) }}"/>
<x-status-icon href="/demographic" icon="fa fa-user-friends" text="Demographic" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/highschool" icon="fa fa-graduation-cap" text="High School" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/academics" icon="fa fa-book" text="Academic" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/financial" icon="fa fa-dollar-sign" text="Financial" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/extracurricular" icon="fa fa-volleyball-ball" text="Extracurricular" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/university" icon="fa fa-university" text="University Plan" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/testing" icon="fa fa-file-alt" text="Testing" progress="{{ rand(1, 100) }}"/> 
<x-status-icon href="/general" icon="fa fa-info" text="General" progress="{{ rand(1, 100) }}"/> 
</div>
