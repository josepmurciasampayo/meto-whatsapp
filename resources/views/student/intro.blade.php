        ...
        <div class="flex flex-col justify-center items-center mx-4">
          ...
          <div class="text-center">
            <p class="my-2 mx-auto">
              You will now be required to answer a series of questions to create your Meto profile. Your answers will determine which universities or programs reach out to you, so please be as thorough and truthful as possible. It will take you about 10 minutes.
            </p>
          </div>
