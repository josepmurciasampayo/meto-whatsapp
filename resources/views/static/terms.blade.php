<x-app-layout>
    <div class="bg-white p-4">
        ...
        <p class="mb-4">Please read these terms of use ("terms of use") carefully before using Meto ("service") operated by Meto Inc ("us", 'we", "our").</p>
        ...
        <p>You agree that all materials, products, and services provided on this website are the property of Meto Inc, its affiliates, directors, officers, employees, agents, suppliers, or licensors including all copyrights, trade secrets, trademarks, patents, and other intellectual property. You also agree that you will not reproduce or redistribute the Meto’s intellectual property in any way, including electronic, digital, or new trademark registrations.</p>
        <p>You grant Meto a royalty-free and non-exclusive license to display, use, copy, transmit, and broadcast the content you upload and publish in accordance with its privacy policy. For issues regarding intellectual property claims, you should contact the company in order to come to an agreement.</p>
        <h3>USER ACCOUNTS</h3>
        ...
        <p>By visiting this website, you agree that the laws of the District of Columbia in United States, without regard to principles of conflict laws, will govern these terms and conditions, or any dispute of any sort that might come between Meto and you, or its business partners and associates.</p>
        <h3>DISPUTES</h3>
        ...
        <p>You agree to indemnify Meto and its affiliates and hold Meto harmless against legal claims and demands that may arise from your use or misuse of our services. We reserve the right to select our own legal counsel.</p>
