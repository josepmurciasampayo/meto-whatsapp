    ...
    <td colspan="6">
        <div class="bg-white text-gray-600 dark:bg-gray-800 dark:text-gray-200 p-12">
            ...
            <div class="text-center mt-6">
                ...
                <?php endif; ?>
                <?php if(isset($levels) && count(array_filter($levels, fn ($level) => $level->count > 0 && $level->selected)) === 0 && count(array_filter($levels, fn ($level) => $level->count > 0)) > 0): ?>
...
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/vendor/opcodesio/log-viewer/src/../resources/views/livewire/log-list.blade.php ENDPATH**/ ?>