...
<?php foreach($attributes->onlyProps(['name' => 'dataTable']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['name' => 'dataTable']); ?>
<?php foreach (array_filter((['name' => 'dataTable']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#<?php echo e($name); ?> thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#<?php echo e($name); ?> thead');

        var table = $('#<?php echo e($name); ?>').DataTable({
            // columnDefs: [
            //     { "width": "5%", "targets": 2 }
            // ],
            paging:false,
...
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/resources/views/components/dataTable.blade.php ENDPATH**/ ?>