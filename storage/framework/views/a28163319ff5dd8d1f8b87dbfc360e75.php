...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('LtkfqVD')) {
    $componentId = $_instance->getRenderedChildComponentId('LtkfqVD');
    $componentTag = $_instance->getRenderedChildComponentTagName('LtkfqVD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LtkfqVD');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('LtkfqVD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
} elseif ($_instance->childHasBeenRendered('JOePv0V')) {
    $componentId = $_instance->getRenderedChildComponentId('JOePv0V');
    $componentTag = $_instance->getRenderedChildComponentTagName('JOePv0V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JOePv0V');
} else {
    $response = \Livewire\Livewire::mount('log-viewer::log-list');
    $html = $response->html();
    $_instance->logRenderedChild('JOePv0V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/vendor/opcodesio/log-viewer/src/../resources/views/index.blade.php ENDPATH**/ ?>