...
<?php endif; ?> -->
            ...
            <div class="flex">
                <div class="mt-5 mr-2"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
} elseif ($_instance->childHasBeenRendered('visnyOu')) {
    $componentId = $_instance->getRenderedChildComponentId('visnyOu');
    $componentTag = $_instance->getRenderedChildComponentTagName('visnyOu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('visnyOu');
} else {
    $response = \Livewire\Livewire::mount('students.student-connections-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('visnyOu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
