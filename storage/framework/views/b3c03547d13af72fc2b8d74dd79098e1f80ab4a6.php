...
} elseif ($_instance->childHasBeenRendered('BwMsAW2')) {
    $componentId = $_instance->getRenderedChildComponentId('BwMsAW2');
    $componentTag = $_instance->getRenderedChildComponentTagName('BwMsAW2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BwMsAW2');
} else {
    $response = \Livewire\Livewire::mount('uni.student-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('BwMsAW2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
                    ...
                    <div class="mt-3">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.inputs.textarea','data' => ['name' => 'upcoming_webinar_events','label' => 'Upcoming Webinar or Events']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'upcoming_webinar_events','label' => 'Upcoming Webinar or Events']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
