...
<div class="invite-popup-box" style="display:none">
    <div class="invite-popup">
        ...
        <button class="invite-popup-copy-btn" onclick="copyToClipboard('<?php echo e($inviteText); ?>')">Copy <i class="fa fa-copy"></i></button>
        <hr>
        ...
        <form method="POST" action="<?php echo e(route('inviteFriends')); ?>">
            ...
            <div class="input-group">
                ...
                <button class="invite-popup-btn" onclick="inviteUser(event, '<?php echo e($inviteText); ?>')">Invite <i class="fa fa-paper-plane"></i></button>
            </div>
        </form>
...
function inviteUser(inviteText) {
    ...
    if (email === '') {
        ...
        const form = document.querySelector('form[action="<?php echo e(route('inviteFriends')); ?>"]');
        form.submit();
    }
}
</script>
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/resources/views/components/invite-friend-popup.blade.php ENDPATH**/ ?>