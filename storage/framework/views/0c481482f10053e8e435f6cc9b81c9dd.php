    ...
    >
        <div class="py-2">
            <button wire:click="clearCache('<?php echo e($logFile->identifier); ?>')" x-on:click.stop="cacheRecentlyCleared = false;" x-data="{ cacheRecentlyCleared: <?php echo json_encode($cacheRecentlyCleared, 15, 512) ?> }" x-init="setTimeout(() => cacheRecentlyCleared = false, 2000)">
                ...
                <span x-show="!cacheRecentlyCleared" wire:loading wire:target="clearCache('<?php echo e($logFile->identifier); ?>')">Clearing...</span>
...
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/vendor/opcodesio/log-viewer/src/../resources/views/partials/file-list-item.blade.php ENDPATH**/ ?>