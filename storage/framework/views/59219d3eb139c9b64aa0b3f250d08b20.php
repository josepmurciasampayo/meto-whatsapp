...
} elseif ($_instance->childHasBeenRendered('WPKfs2Z')) {
    $componentId = $_instance->getRenderedChildComponentId('WPKfs2Z');
    $componentTag = $_instance->getRenderedChildComponentTagName('WPKfs2Z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WPKfs2Z');
} else {
    $response = \Livewire\Livewire::mount('uni.student-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('WPKfs2Z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
