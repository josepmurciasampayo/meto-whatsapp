...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', config('app.name') . ' - University Homepage'); ?>
...
<?php endif; ?>
        ...
        <div class="d-flex justify-content-center">
            <form method="POST" action="<?php echo e(route('uni.homepage.store')); ?>" class="w-50">
                <?php echo csrf_field(); ?>
                <h3 class="display-7 mb-1 mt-4">What is the website URL that will lead students to your institution's homepage?</h3>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.inputs.text','data' => ['saved' => ''.e($uni->url).'','name' => 'url']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['saved' => ''.e($uni->url).'','name' => 'url']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php endif; ?>
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/resources/views/uni/homepage.blade.php ENDPATH**/ ?>