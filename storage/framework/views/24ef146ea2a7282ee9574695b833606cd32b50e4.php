<?php if($row['curriculum'] == \App\Enums\Student\Curriculum::AMERICAN()): ?> <!-- American -->
    <p class="detail">
        ...
        <br />
        <span class="info"><?php echo e(''); ?></span>
    </p>
    <p class="detail">
...
<?php elseif($row['curriculum'] == \App\Enums\Student\Curriculum::CAMBRIDGE()): ?> <!-- Cambridge -->
    <p class="detail">
