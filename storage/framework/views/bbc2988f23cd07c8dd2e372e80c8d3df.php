...
<?php foreach($attributes->onlyProps(['label' => '', 'name', 'class' => '', 'type' => null, 'help' => false, 'disabled' => false, 'saved' => "", 'req' => false, 'mask' => '']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['label' => '', 'name', 'class' => '', 'type' => null, 'help' => false, 'disabled' => false, 'saved' => "", 'req' => false, 'mask' => '']); ?>
<?php foreach (array_filter((['label' => '', 'name', 'class' => '', 'type' => null, 'help' => false, 'disabled' => false, 'saved' => "", 'req' => false, 'mask' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
