...
<?php $component->withAttributes([]); ?>
    <div class="text-end my-3">
        <a href="<?php echo e(route('uni.create')); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Invite New University <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <table id="dataTable" class="table table-striped bg-white">
        ...
        <tr>
            <td><a href="<?php echo e(route('uni', ['id' => $row['id']])); ?>"><?php echo e($row['name']); ?></a></td>
            <td><?php echo e($row['user_count']); ?></td>
            <td><?php echo e($data['counts'][$row['id']] ?? '-'); ?></td>
            <td><?php echo e($row['connections']); ?></td>
        </tr>
        <?php } ?>
        </tbody>
    </table>
...
<?php endif; ?>
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/resources/views/admin/universities.blade.php ENDPATH**/ ?>