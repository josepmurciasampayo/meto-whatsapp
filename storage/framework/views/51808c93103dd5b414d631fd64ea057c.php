...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', config('app.name') . ' - University Name'); ?>
...
<?php endif; ?>
        ...
        <div class="d-flex justify-content-center">
            <form method="POST" class="w-50" action="<?php echo e(route('uni.name.store')); ?>">
                <?php echo csrf_field(); ?>
                <h3 class="display-7 mb-1 mt-4">What is the name of your institution?</h3>
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.inputs.text','data' => ['name' => 'name','saved' => ''.e($uni->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'name','saved' => ''.e($uni->name).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
...
<?php endif; ?>
<?php /**PATH /Users/hbakouane/Desktop/valet/meto/resources/views/uni/name.blade.php ENDPATH**/ ?>